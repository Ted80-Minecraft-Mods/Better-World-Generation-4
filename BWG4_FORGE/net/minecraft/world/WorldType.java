...
public class WorldType
{
	...
	//BWG4 BIG WORLDTYPES
	public static final WorldType BWG4DEFAULT = (new WorldType(10, "BetterDefault")).setCanBeCreated(false).setBWG4Worldtype(true);
    ...
    public static final WorldType BWG4SKYLAND = (new WorldType(22, "Survival Skyland")).setBWG4Worldtype(true);
    public static final WorldType BWG4SKYBLOCK = (new WorldType(23, "Skyblock")).setBWG4Worldtype(true);
    ...
    public WorldType setBWG4Worldtype(boolean par1)
    {
        this.bwg4worldtype = par1;
        return this;
    }
    //=============================================
