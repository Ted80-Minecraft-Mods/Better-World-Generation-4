...
import net.minecraft.world.gen.BWG4NoiseOctavesBeta;
import net.minecraft.world.gen.feature.BWG4decoPumpkin;
...
public class BiomeDecorator
{
    ...
    protected void generateOres()
    {
		...
		if(emeralds == true)
		{
			genStandardOre1(3 + randomGenerator.nextInt(6), emeraldGen, 4, 32);
		}
		if(silverfish == true)
		{
			genStandardOre1(7, silverfishGen, 0, 64);
		}
		if(disableoreheight == true) //IF CAVE WORLDS
		{
			genStandardOre1(2, diamondGen, 0, 128);
		}
		else
		{
