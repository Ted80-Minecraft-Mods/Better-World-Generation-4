    ...
    public BWG4BiomesDefault(int par1, int vartype, int varid)
    {
		...
		if(type == 1)
		{
			...
			if(id == 4)//Mushroom Island
			{
				...
				spawnableCreatureList.add(new SpawnListEntry(net.minecraft.entity.passive.EntityMooshroom.class, 8, 4, 8));
			}
			if(id == 5)//Beach
			{
				spawnableCreatureList.clear();
		...
		else if(type == 2)
		{
			if(id == 1)//Snow Pines
			{
				...
				spawnableCreatureList.add(new SpawnListEntry(net.minecraft.entity.passive.EntityWolf.class, 8, 4, 4));
		...
		else if(type == 4)
		{
			...
			if(id == 3 || id == 5)//Swampland
			{
				...
				spawnableMonsterList.add(new SpawnListEntry(net.minecraft.entity.monster.EntitySlime.class, 1, 1, 1));
