...
public class BWG4BiomesSurvival extends BiomeGenBase
{
    ...
    public BWG4BiomesSurvival(int par1)
    {
		...
		else if(biomeID == 119) //survival_nether
		{
			...
			this.spawnableMonsterList.add(new SpawnListEntry(net.minecraft.entity.monster.EntityGhast.class, 50, 4, 4));
			this.spawnableMonsterList.add(new SpawnListEntry(net.minecraft.entity.monster.EntityPigZombie.class, 100, 4, 4));
			this.spawnableMonsterList.add(new SpawnListEntry(net.minecraft.entity.monster.EntityMagmaCube.class, 1, 4, 4));
			this.spawnableMonsterList.add(new SpawnListEntry(net.minecraft.entity.monster.EntityMagmaCube.class, 1, 4, 4));
			spawnableMonsterList.add(new SpawnListEntry(net.minecraft.entity.monster.EntityBlaze.class, 25, 4, 4));
		}
