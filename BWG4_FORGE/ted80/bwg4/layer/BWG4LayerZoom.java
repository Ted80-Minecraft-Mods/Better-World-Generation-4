...
public class BWG4LayerZoom extends BWG4Layer
{
    public BWG4LayerZoom(long par1, BWG4Layer par3GenLayer)
    {
        super(par1);
    ...
    public static BWG4Layer func_75915_a(long par0, BWG4Layer par2GenLayer, int par3)
    {
        Object object = par2GenLayer;

        for (int k = 0; k < par3; ++k)
        {
            object = new BWG4LayerZoom(par0 + (long)k, (BWG4Layer)object);
        }

        return (BWG4Layer)object;
    }
}
