...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.buttonGenerateStructures = new GuiButton(4, this.width / 2 - 165, 100, 160, 20, stringtranslate.translateKey("selectWorld.mapFeatures")));
        this.buttonGenerateStructures.drawButton = false;
        this.buttonList.add(this.buttonBonusItems = new GuiButton(7, this.width / 2 - 165, 125, 160, 20, stringtranslate.translateKey("selectWorld.bonusItems")));
        this.buttonBonusItems.drawButton = false;
        this.buttonList.add(this.buttonWorldType = new GuiButton(5, this.width / 2 + 5, 100, 160, 20, stringtranslate.translateKey("selectWorld.mapType")));
        this.buttonWorldType.drawButton = false;
        this.buttonList.add(this.buttonAllowCommands = new GuiButton(6, this.width / 2 - 165, 151, 160, 20, stringtranslate.translateKey("selectWorld.allowCommands")));
        this.buttonAllowCommands.drawButton = false;
        this.buttonList.add(this.buttonCustomize = new GuiButton(8, this.width / 2 + 5, 125, 160, 20, stringtranslate.translateKey("selectWorld.customizeType")));
        ...
        this.buttonList.add(this.buttonCustomDefault1 = new GuiButton(19, this.width / 2 + 5, 150, 160, 20, stringtranslate.translateKey("selectWorld.customizeType"))); 
        this.buttonList.add(this.buttonCustomDefault2 = new GuiButton(20, this.width / 2 + 5, 150, 160, 20, stringtranslate.translateKey("selectWorld.customizeType"))); 
    ...
    private void updateButtonText()
    {
		...
		if(selectDefault == 0) { buttonDefault.displayString = "Better Default: " + stringtranslate.translateKey("options.off"); }
		else { buttonDefault.displayString = "Better Default: " + stringtranslate.translateKey("options.on"); }
		
		if(selectLargeBiomes == 0) { buttonLargeBiomes.displayString = "Better Default: " + stringtranslate.translateKey("options.off"); } 
		else { buttonLargeBiomes.displayString = "Better Default: " + stringtranslate.translateKey("options.on"); }
		
		if(selectBeta == 0) { buttonBeta.displayString = "Biomes: Beta"; } 
		else { buttonBeta.displayString = "Biomes: Default"; }
		
		if(selectInfdev == 0) { buttonInfdev.displayString = "Snow World: " + stringtranslate.translateKey("options.off"); }
		else { buttonInfdev.displayString = "Snow World: " + stringtranslate.translateKey("options.on"); }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            else if (par1GuiButton.id == 0)
            {
				...
				//====== BWG4 ======
				if(selectIndev2 == 1 && worldTypeId == 17) { worldsettings.func_82750_a("2"); }
				else if(selectIndev2 == 2 && worldTypeId == 17) { worldsettings.func_82750_a("3"); }
				else if(selectIndev2 == 3 && worldTypeId == 17) { worldsettings.func_82750_a("4"); }
				else if(selectIndev2 == 4 && worldTypeId == 17) { worldsettings.func_82750_a("5"); }
				else if(selectIndev2 == 1 && worldTypeId == 18) { worldsettings.func_82750_a("2"); }
				else if(selectIndev2 == 2 && worldTypeId == 18) { worldsettings.func_82750_a("3"); }
				else if(selectIndev2 == 3 && worldTypeId == 18) { worldsettings.func_82750_a("4"); }
				else if(selectIndev2 == 4 && worldTypeId == 18) { worldsettings.func_82750_a("5"); }
				else if(selectInfdev == 0 && worldTypeId == 16) { worldsettings.func_82750_a("1"); }
				else if(selectInfdev == 1 && worldTypeId == 16) { worldsettings.func_82750_a("2"); } //buttonSkyBlock selectSkyBlock
				else if(selectIsland == 0 && worldTypeId == 21) { worldsettings.func_82750_a("1"); }
				else if(selectIsland == 1 && worldTypeId == 21) { worldsettings.func_82750_a("2"); }
				else if(selectIsland == 2 && worldTypeId == 21) { worldsettings.func_82750_a("3"); }
				else if(selectIsland == 3 && worldTypeId == 21) { worldsettings.func_82750_a("4"); }
				else if(selectIsland == 4 && worldTypeId == 21) { worldsettings.func_82750_a("5"); }
				else if(selectSkyland == 0 && worldTypeId == 22) { worldsettings.func_82750_a("1"); }
				else if(selectSkyland == 1 && worldTypeId == 22) { worldsettings.func_82750_a("2"); }
				else if(selectSkyland == 2 && worldTypeId == 22) { worldsettings.func_82750_a("3"); }
				else if(selectSkyland == 3 && worldTypeId == 22) { worldsettings.func_82750_a("4"); }
				else if(selectSkyland == 4 && worldTypeId == 22) { worldsettings.func_82750_a("5"); }
