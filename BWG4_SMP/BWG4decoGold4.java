...
public class BWG4decoGold4 extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int x, int y, int z)
    {
		...
		{	
			...
			par1World.setBlockAndMetadataWithNotify(x, y - 1, z, Block.sand.blockID, 0, 2);
			int var10 = 2 + par2Random.nextInt(par2Random.nextInt(3) + 1);
			for (int var11 = 0; var11 < var10; ++var11)
			{
				par1World.setBlockAndMetadataWithNotify(x, y + var11, z, Block.cactus.blockID, 0, 2);
			}
		}
		...
		{	
			...
			par1World.setBlockAndMetadataWithNotify(x + 0, y + rand + 1, z + 1, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 1, y + rand + 2, z + 2, Block.wood.blockID, 0, 2);
			...
			par1World.setBlockAndMetadataWithNotify(x + 1, y + rand + 0, z + 0, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 2, y + rand + 1, z + 0, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 3, y + rand + 2, z - 1, Block.wood.blockID, 0, 2);
			...
			par1World.setBlockAndMetadataWithNotify(x - 2, y + rand + 1, z + 0, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x - 3, y + rand + 2, z - 1, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x - 4, y + rand + 3, z - 2, Block.wood.blockID, 0, 2);
			...
			par1World.setBlockAndMetadataWithNotify(x + 0, y + rand + 0, z - 1, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 1, y + rand + 1, z - 2, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 2, y + rand + 2, z - 2, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 3, y + rand + 3, z - 2, Block.wood.blockID, 0, 2);
			...
			par1World.setBlockAndMetadataWithNotify(x + 0, y + rand + 0, z - 1, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 0, y + rand + 0, z - 2, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x + 1, y + rand + 1, z - 3, Block.wood.blockID, 0, 2);
			createSavannaLeaves(par1World, par2Random, x + 1, y + rand + 1, z - 3, 3);
			createSavannaLeaves(par1World, par2Random, x + 1, y + rand + 2, z - 3, 2);
			}
			
			//branch6
			par1World.setBlockAndMetadataWithNotify(x - 0, y + rand + 0, z + 0, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x - 0, y + rand + 1, z + 0, Block.wood.blockID, 0, 2);
			par1World.setBlockAndMetadataWithNotify(x - 0, y + rand + 2, z - 0, Block.wood.blockID, 0, 2);
	...
	private void createSavannaLeaves(World par1World, Random par2Random, int x, int y, int z, int size)
	{
		...
		if(size==3){par1World.setBlockAndMetadataWithNotify(x, y, z, Block.wood.blockID, 0, 2);}
	}
