...
public class BWG4GuiDefault extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 100, 20, StatCollector.translateToLocal("gui.done")));
        this.controlList.add(new GuiButton(1, this.width / 2 - 50, this.height - 28, 100, 20, StatCollector.translateToLocal("gui.cancel")));
        this.controlList.add(this.buttonEnable = new GuiButton(2, this.width / 2 - 155, this.height - 52, 100, 20, "Enable/Disable"));
        this.controlList.add(this.buttonAll = new GuiButton(3, this.width / 2 - 50, this.height - 52, 100, 20, "Disable All"));
        this.controlList.add(this.buttonBiome = new GuiButton(4, this.width / 2 + 55, this.height - 52, 100, 20, "-")); //Biome Settings
        this.controlList.add(this.buttonSetting = new GuiButton(5, this.width / 2 + 55, this.height - 28, 100, 20, "-")); //World Settings
		...
		//this.controlList.add(this.biomeMinHeight = new GuiSlider(10, this.width / 2 + 55, 28, 10, "Min Height", 0.3F));     
		//this.controlList.add(this.biomeMaxHeight = new GuiSlider(11, this.width / 2 + 55, 28, 11, "Max Height", 0.3F));         
		//this.controlList.add(this.biomeDungeon = new GuiSlider(12, this.width / 2 + 55, 28, 12, "Dungeons Per Chunk", 0.3F));       
