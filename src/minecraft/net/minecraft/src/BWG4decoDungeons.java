...
public class BWG4decoDungeons extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
		if(isSkyDungeon || isEndDungeon)
		{
			...
			//Build Chains
			for(int chy1 = par4 + 5; chy1 < 70 ; chy1++) { if(!par1World.isAirBlock(par3 + 4, chy1, par5 + 4)) { break; } par1World.setBlockWithNotify(par3 + 4, chy1, par5 + 4, Block.fenceIron.blockID); }		
			for(int chy2 = par4 + 5; chy2 < 70 ; chy2++) { if(!par1World.isAirBlock(par3 + 4, chy2, par5 - 4)) { break; } par1World.setBlockWithNotify(par3 + 4, chy2, par5 - 4, Block.fenceIron.blockID); }		
			for(int chy3 = par4 + 5; chy3 < 70 ; chy3++) { if(!par1World.isAirBlock(par3 - 4, chy3, par5 + 4)) { break; } par1World.setBlockWithNotify(par3 - 4, chy3, par5 + 4, Block.fenceIron.blockID); }		
			for(int chy4 = par4 + 5; chy4 < 70 ; chy4++) { if(!par1World.isAirBlock(par3 - 4, chy4, par5 - 4)) { break; } par1World.setBlockWithNotify(par3 - 4, chy4, par5 - 4, Block.fenceIron.blockID); }	
			if(checkpos)
			{	
				par1World.setBlockWithNotify(par3 + 4, par4 + 6, par5 + 4, Block.netherBrick.blockID);
				par1World.setBlockWithNotify(par3 + 4, par4 + 6, par5 - 4, Block.netherBrick.blockID);
				par1World.setBlockWithNotify(par3 - 4, par4 + 6, par5 + 4, Block.netherBrick.blockID);
				par1World.setBlockWithNotify(par3 - 4, par4 + 6, par5 - 4, Block.netherBrick.blockID);
			}
			...
			{
				par1World.setBlockWithNotify(par3 + 4, par4 + 6, par5 + 4, Block.cobblestoneMossy.blockID);
				par1World.setBlockWithNotify(par3 + 4, par4 + 6, par5 - 4, Block.cobblestoneMossy.blockID);
				par1World.setBlockWithNotify(par3 - 4, par4 + 6, par5 + 4, Block.cobblestoneMossy.blockID);
				par1World.setBlockWithNotify(par3 - 4, par4 + 6, par5 - 4, Block.cobblestoneMossy.blockID);
			}	
			...
			for(int x1 = par3 - 4; x1 < par3 + 5 ; x1++)
			{
				for(int y1 = par4; y1 < par4 + 6 ; y1++)
				{
					for(int z1 = par5 - 4; z1 < par5 + 5 ; z1++)
					{
						...
						{
							par1World.setBlockWithNotify(x1, y1, z1, 0);
						}
						else
						{
							if(checkpos)
							{
								par1World.setBlockWithNotify(x1, y1, z1, Block.netherBrick.blockID);
							}
							else
							{
								if (par2Random.nextInt(2) != 0)
								{
									par1World.setBlockWithNotify(x1, y1, z1, Block.cobblestoneMossy.blockID);
								}
								else
								{
									par1World.setBlockWithNotify(x1, y1, z1, Block.cobblestone.blockID);
								}
							}
						}
					}
			...
			for(int x2 = par3 - 3; x2 < par3 + 4 ; x2++)
			{
				for(int y2 = par4 + 1; y2 < par4 + 5 ; y2++)
				{
					...
					{
						par1World.setBlockWithNotify(x2, y2, z2, 0);
					}
				}
			}
			...
			if(isEndDungeon)
			{
				par1World.setBlockAndMetadataWithNotify(par3 + 2, par4 + 1, par5 - 1, Block.endPortalFrame.blockID, 1 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 + 2, par4 + 1, par5 + 0, Block.endPortalFrame.blockID, 1 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 + 2, par4 + 1, par5 + 1, Block.endPortalFrame.blockID, 1 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				
				par1World.setBlockAndMetadataWithNotify(par3 - 1, par4 + 1, par5 + 2, Block.endPortalFrame.blockID, 2 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 + 0, par4 + 1, par5 + 2, Block.endPortalFrame.blockID, 2 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 + 1, par4 + 1, par5 + 2, Block.endPortalFrame.blockID, 2 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				
				par1World.setBlockAndMetadataWithNotify(par3 - 2, par4 + 1, par5 - 1, Block.endPortalFrame.blockID, 3 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 - 2, par4 + 1, par5 + 0, Block.endPortalFrame.blockID, 3 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 - 2, par4 + 1, par5 + 1, Block.endPortalFrame.blockID, 3 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				
				par1World.setBlockAndMetadataWithNotify(par3 - 1, par4 + 1, par5 - 2, Block.endPortalFrame.blockID, 0 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 + 0, par4 + 1, par5 - 2, Block.endPortalFrame.blockID, 0 + (par2Random.nextFloat() > 0.9F ? 4 : 0));
				par1World.setBlockAndMetadataWithNotify(par3 + 1, par4 + 1, par5 - 2, Block.endPortalFrame.blockID, 0 + (par2Random.nextFloat() > 0.9F ? 4 : 0));

				par1World.setBlockWithNotify(par3, par4 + 6, par5, Block.mobSpawner.blockID);
				TileEntityMobSpawner spawn3 = (TileEntityMobSpawner)par1World.getBlockTileEntity(par3, par4 + 6, par5);
				if (spawn3 != null) { spawn3.setMobID(this.pickMobSpawner(par2Random)); }
			}
			else
			{
				par1World.setBlockWithNotify(par3, par4 + 1, par5, Block.mobSpawner.blockID);
				par1World.setBlockWithNotify(par3, par4 + 3, par5, Block.mobSpawner.blockID);
				par1World.setBlockWithNotify(par3, par4 + 6, par5, Block.mobSpawner.blockID);
				...
				TileEntityMobSpawner spawn3 = (TileEntityMobSpawner)par1World.getBlockTileEntity(par3, par4 + 6, par5);
				if (spawn1 != null) { spawn1.setMobID(this.pickMobSpawner(par2Random)); }
				if (spawn2 != null) { spawn2.setMobID(this.pickMobSpawner(par2Random)); }
				if (spawn3 != null) { spawn3.setMobID(this.pickMobSpawner(par2Random)); }
				
				par1World.setBlockWithNotify(par3, par4 + 2, par5, Block.chest.blockID);
    ...
    private ItemStack pickCheckLootItem(Random par1Random, int listitem)
    {
		...
		if(chestID == 0)//DEFAULT LOOT
		{
			...
			if (i == 16) { return Item.field_92105_bW.func_92109_a(par1Random); }
			else { return null; }		
		} 
		else if(chestID == 1)//BETA1 LOOT
		{
			int i = par1Random.nextInt(16);
			...
			if (i == 14) { return Item.field_92105_bW.func_92109_a(par1Random); }
		...
		else if(chestID == 2)//BETA2 LOOT
		{
			...
			if (i == 9) { return Item.field_92105_bW.func_92109_a(par1Random); }
		...
		else if(chestID == 18)//SKYLAND LOOT
		{
			...
			if (i == 4) { return Item.field_92105_bW.func_92109_a(par1Random); }
