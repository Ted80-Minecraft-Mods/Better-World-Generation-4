...
public class BWG4ChunkProviderSkyIsland implements IChunkProvider
{
    ...
    public BWG4ChunkProviderSkyIsland(World par1World, long par2, int theme)
    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
		...
		if(par2 == 0 && par3 == 0)
		{
			(new BWG4decoDungeons(11, false, false, true)).generate(endWorld, endRNG, 0, 2, 0);
		}
		else
		{
			if(endRNG.nextInt(12) == 0)
			{
				int j5 = var4 + endRNG.nextInt(16) + 8;
				int k88 = endRNG.nextInt(10);
				int j11 = var5 + endRNG.nextInt(16) + 8;
				(new BWG4decoDungeons(11, false, true, false)).generate(endWorld, endRNG, j5, k88, j11);
			}	
		}		
		...
		if(THEMEID == 3)
		{
			...
			{
				int lql1 = var4 + endRNG.nextInt(16) + 8;
				int lql2 = endRNG.nextInt(128);
				int lql3 = var5 + endRNG.nextInt(16) + 8;
				(new BWG4decoSurvival(5)).generate(endWorld, endRNG, lql1, lql2, lql3);
			}
		}	
