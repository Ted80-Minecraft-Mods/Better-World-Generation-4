...
public class BWG4BiomesSurvival extends BiomeGenBase
{
    ...
    {
		if(biomeID == 97) //island_normal
		{
		}
		else if(biomeID == 98) //island_hell
		{
		}
		else if(biomeID == 99) //island_ice
		{
		}
		else if(biomeID == 100) //island_paradise
		{
		...
		else if(biomeID == 101) //island_normal
		{
		}
		else if(biomeID == 102) //island_normal
		{
		}*/
		else if(biomeID == 103) //skyland_normal
		{
			if(par1Random.nextInt(5) == 0)
			{
				return worldGeneratorForest;
		...
		else if(biomeID == 104) //skyland_hell
		{
		}*/
		else if(biomeID == 105) //skyland_ice
		{
			if (par1Random.nextInt(5) == 0) 
			{ 
		...
		else if(biomeID == 106) //skyland_jungle
		{
			...
			{ 
				return new WorldGenHugeTrees(false, 25 + par1Random.nextInt(10), 3, 3); 
			} 
			else 
			{ 
		...
		else if(biomeID == 107) //island_normal
		{
		}
		else if(biomeID == 108) //island_normal
		{
		}*/
		return new BWG4oldGenTrees(2);
    }
    ...
    {
		if(biomeID == 100) //island_paradise
		{
