...
public class BWG4decoGold1 extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int x, int y, int z)
    {
			...
			for (int var7 = 0; var7 < 32; ++var7)
			{
				...
				if (var11 == Block.waterStill.blockID)
				{
					...
					if(count < 4.0D)
					{
						...
						{
							par1World.setBlockAndMetadata(var8, 62, var10, Block.ice.blockID, 0);
						}	
					}	
				}
			}
		...
		else if(objectID == 5)//new pine tree
		{
			...
			//wood
			for(int ty1 = y - 3; ty1 < randheight + y; ty1++ )  { int block = par1World.getBlockId(x, ty1, z); if(block == 0) { par1World.setBlockAndMetadata(x, ty1, z, Block.wood.blockID, 12); } }
			
			//root
			for(int ry1 = y - 3; ry1 < y + 5; ry1++ ) { int block = par1World.getBlockId(x + 1, ry1, z); if(block == 0) { par1World.setBlockAndMetadata(x + 1, ry1, z, Block.wood.blockID, 12); if(ry1 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
			for(int ry2 = y - 3; ry2 < y + 5; ry2++ ) { int block = par1World.getBlockId(x - 1, ry2, z); if(block == 0) { par1World.setBlockAndMetadata(x - 1, ry2, z, Block.wood.blockID, 12); if(ry2 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
			for(int ry3 = y - 3; ry3 < y + 5; ry3++ ) { int block = par1World.getBlockId(x, ry3, z - 1); if(block == 0) { par1World.setBlockAndMetadata(x, ry3, z - 1, Block.wood.blockID, 12); if(ry3 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
			for(int ry4 = y - 3; ry4 < y + 5; ry4++ ) { int block = par1World.getBlockId(x, ry4, z + 1); if(block == 0) { par1World.setBlockAndMetadata(x, ry4, z + 1, Block.wood.blockID, 12); if(ry4 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
