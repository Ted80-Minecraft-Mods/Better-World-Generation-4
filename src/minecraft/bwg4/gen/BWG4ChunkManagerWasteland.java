...
public class BWG4ChunkManagerWasteland extends WorldChunkManager
{
	...
	protected BWG4ChunkManagerWasteland()
	{
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();

        this.biomesToSpawnIn.add(BWG4Biomes.WASTELANDdesert);
        this.biomesToSpawnIn.add(BWG4Biomes.WASTELANDforest);
        this.biomesToSpawnIn.add(BWG4Biomes.WASTELANDmountains);
        this.biomesToSpawnIn.add(BWG4Biomes.WASTELANDplains);
	}

    public BWG4ChunkManagerWasteland(World par1World)
    {
        this();
        long seed = par1World.getSeed();

        BWG4Layer[] var4 = BWG4Layer.initializeWastelandGenerators(seed);
