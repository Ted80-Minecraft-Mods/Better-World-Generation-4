...
public class BWG4ChunkProviderSurvivalNether implements IChunkProvider
{
    ...
    public BWG4ChunkProviderSurvivalNether(World par1World, long par2)
    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        for (int lr = 0; lr < 15; ++lr)
        {
            ...
            (new WorldGenHellLava(Block.lavaMoving.blockID, false)).generate(this.endWorld, this.endRNG, lr1, lr2, lr3);
        }
        ...
        if (endRNG.nextInt(2) == 0) 
        {
			...
			(new BWG4decoSurvival(2)).generate(this.endWorld, this.endRNG, nt1, endWorld.getHeightValue(nt1, nt3), nt3);
        }
        ...
        for (int ns = 0; ns < 1; ++ns)
        {
			...
			(new BWG4decoSurvival(3)).generate(this.endWorld, this.endRNG, ns1, ns2, ns3);
        }		
        ...
        if (endRNG.nextInt(1) == 0)
        {
            ...
            (new WorldGenFlowers(Block.mushroomBrown.blockID)).generate(this.endWorld, this.endRNG, mb1, mb2, mb3);
        }
        ...
        if (endRNG.nextInt(1) == 0)
        {
            ...
            (new WorldGenFlowers(Block.mushroomRed.blockID)).generate(this.endWorld, this.endRNG, mr1, mr2, mr3);
        }				
