...
import bwg4.deco.BWG4decoPumpkin;
...
public class BWG4ChunkProviderSkyIsland implements IChunkProvider
{
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        var6.decorate(this.world, this.rand, var4, var5);
		...
		if(THEMEID == 2) //SNOW
		{
			...
			for (int ice = 0; ice < 80; ++ice)
			{
				...
				(new BWG4decoSurvival(5)).generate(world, rand, lql1, lql2, lql3);
			}
		}
		if(THEMEID == 3) //JUNGLE
		{
		...
		if(par2 == 0 && par3 == 0)
		{
			(new BWG4decoDungeons(1, false, false, true, false)).generate(world, rand, 0, 2, 0);
		}
		else
		{
			if(rand.nextInt(deco_dungeon) == 0)
			{
				...
				(new BWG4decoDungeons(1, false, false, true, false)).generate(world, rand, j5, k88, j11);
			}	
		}		
		...
		if (rand.nextInt(deco_melon) == 0)
		{
			...
			(new BWG4decoPumpkin(1)).generate(world, rand, mel1, mel2, mel3);
		}
		...
		if (rand.nextInt(deco_pumpkin) == 0)
		{
			...
			(new BWG4decoPumpkin(0)).generate(world, rand, pum1, pum2, pum3);
		}
