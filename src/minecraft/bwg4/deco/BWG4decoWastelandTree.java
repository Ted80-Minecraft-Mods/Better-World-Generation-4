...
public class BWG4decoWastelandTree extends WorldGenerator
{
    ...
    public BWG4decoWastelandTree(int sizeinput, int typeinput)
    {
        size = sizeinput;
		type = typeinput;
    }
    
    public BWG4decoWastelandTree()
    {
    	this(9 + ((int) Math.floor(Math.random() * 5)), 0);
    }
