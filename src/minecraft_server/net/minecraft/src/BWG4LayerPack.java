        ...
        for (int var11 = 0; var11 < par4; ++var11)
        {
            for (int var12 = 0; var12 < par3; ++var12)
            {
				...
				{ 
					...
					if(var13 == 0) //COLD
					{ 
						var10[var12 + var11 * par3] = 0; //nextInt(2) + 0; 
					}
					else if(var13 == 1) //NORM
					{
						var10[var12 + var11 * par3] = 11; //nextInt(2) + 10;
					}
					else if(var13 == 2) //WARM
					{
						var10[var12 + var11 * par3] = 21; //nextInt(3) + 20;
					}
					else //HOT
					{
						var10[var12 + var11 * par3] = 30; //nextInt(3) + 30;
					} 
				}
				else
				{
