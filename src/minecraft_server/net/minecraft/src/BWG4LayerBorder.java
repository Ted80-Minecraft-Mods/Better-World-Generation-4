...
public class BWG4LayerBorder extends GenLayer
{
    public BWG4LayerBorder(long par1, GenLayer par3GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int var7 = 0; var7 < par4; ++var7)
        {
            for (int var8 = 0; var8 < par3; ++var8)
            {
				...
				if (var9 >= BiomeGenBase.GOLD1snowpineLake.biomeID && var9 <= BiomeGenBase.GOLD1snowpineHigh.biomeID) //PINEFOREST
				{	
