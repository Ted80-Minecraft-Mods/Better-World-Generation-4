...
public class BWG4decoDungeons extends WorldGenerator
{
    ...
    private ItemStack pickCheckLootItem(Random par1Random, int listitem)
    {
		...
		if(chestID == 0)//DEFAULT LOOT
		{
			...
			if (i == 16) { return Item.field_92053_bW.func_92055_a(par1Random); }
			else { return null; }		
		} 
		else if(chestID == 1)//BETA1 LOOT
		{
			...
			if (i == 14) { return Item.field_92053_bW.func_92055_a(par1Random); }
		...
		else if(chestID == 2)//BETA2 LOOT
		{
			...
			if (i == 9) { return Item.field_92053_bW.func_92055_a(par1Random); }
		...
		else if(chestID == 18)//SKYLAND LOOT
		{
			...
			if (i == 4) { return Item.field_92053_bW.func_92055_a(par1Random); }
