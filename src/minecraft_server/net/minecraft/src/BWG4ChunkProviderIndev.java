			...
			for (int var85 = 0; var85 < 16; ++var85)
			{
				for (int var86 = 0; var86 < 16; ++var86)
				{
					...
					if(var87 > var6.snowLevel)
					{
						...
						{
							this.worldObj.setBlockWithNotify(var85 + var4, var87 - 1, var86 + var5, Block.ice.blockID);
						}

						if (this.worldObj.canSnowAt(var85 + var4, var87, var86 + var5))
						{
							this.worldObj.setBlockWithNotify(var85 + var4, var87, var86 + var5, Block.snow.blockID);
						}
					}	
				}
			}
