...
public class BWG4ChunkProviderAlpha implements IChunkProvider
{
    ...
    public Chunk provideChunk(int i, int j)
    {
        ...
        double ad[] = worldObj_16.getWorldChunkManager().temperature;
    ...
    private double[] initializeNoiseField(double ad[], int i, int j, int k, int l, int i1, int j1)
    {
        ...
        double ad1[] = worldObj_16.getWorldChunkManager().temperature;
        double ad2[] = worldObj_16.getWorldChunkManager().humidity;
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        field_4178_w = worldObj_16.getWorldChunkManager().getColdTemperatures(field_4178_w, k + 8, l + 8, 16, 16);
        for(int k15 = k + 8; k15 < k + 8 + 16; k15++)
        {
            for(int j18 = l + 8; j18 < l + 8 + 16; j18++)
            {
                ...
                if(d1 < 0.5D && i21 > 0 && i21 < 128 && worldObj_16.isAirBlock(k15, i21, j18))
                {
					...
					{
						worldObj_16.setBlockWithNotify(k15, i21, j18, Block.snow.blockID);
					}
					else if ( worldObj_16.getBlockMaterial(k15, i21 - 1, j18) == Material.water )
					{
						worldObj_16.setBlockWithNotify(k15, i21 - 1, j18, Block.ice.blockID);					
					}
                }
            }
