...
public class BWG4LayerBiome extends GenLayer
{
    ...
    public BWG4LayerBiome(long par1, GenLayer par3GenLayer, WorldType par4WorldType, String[] Settings, int world, boolean remote)
    {
        super(par1);
		worldID = world;
		parent = par3GenLayer;
		...
		//GOLD
		ColdHills = new BiomeGenBase[] {BiomeGenBase.GOLD1snowpineLake, BiomeGenBase.GOLD1snowpineForest, BiomeGenBase.GOLD1snowpineHigh};
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int var7 = 0; var7 < par4; ++var7)
        {
            for (int var8 = 0; var8 < par3; ++var8)
            {
				...
				if (worldID == 1) 
				{
					if (var9 == 0) { var6[var8 + var7 * par3] = ColdHills[nextInt(ColdHills.length)].biomeID; }
