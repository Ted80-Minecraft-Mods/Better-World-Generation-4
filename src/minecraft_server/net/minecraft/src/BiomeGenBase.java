...
public abstract class BiomeGenBase
{
	...
	public static final BiomeGenBase BDocean = (new BWG4BiomesDefault(121, 1, 1)).setColor(353825).setBiomeName("Ocean").setTemperatureRainfall(0.8F, 0.6F).setMinMaxHeight(-1.1F, 0.3F).beach(1);
	public static final BiomeGenBase BDtropicalisland = (new BWG4BiomesDefault(122, 1, 2)).setColor(353825).setBiomeName("Tropical Island").setTemperatureRainfall(1.0F, 1.0F).setMinMaxHeight(0.2F, 0.3F).beach(1);
	public static final BiomeGenBase BDjungleisland = (new BWG4BiomesDefault(123, 1, 3)).setColor(353825).setBiomeName("Jungle Island").setTemperatureRainfall(1.0F, 1.0F).setMinMaxHeight(0.2F, 0.3F).beach(1);
	...
	public static final BiomeGenBase BDbeach = (new BWG4BiomesDefault(125, 1, 5)).setColor(353825).setBiomeName("Beach").setTemperatureRainfall(0.8F, 0.6F).setMinMaxHeight(0.0F, 0.1F).beach(2); 
	public static final BiomeGenBase BDbeachDunes = (new BWG4BiomesDefault(126, 1, 6)).setColor(353825).setBiomeName("Beach Dunes").setTemperatureRainfall(0.8F, 0.6F).setMinMaxHeight(0.3F, 0.2F).beach(2); 
	public static final BiomeGenBase BDsnowpines = (new BWG4BiomesDefault(127, 2, 1)).setColor(353825).setBiomeName("Snow Pines").setTemperatureRainfall(0.0F, 0.0F).setMinMaxHeight(0.2F, 0.7F).setEnableSnow().beach(1);
	...
	public static final BiomeGenBase BDsnowtaiga = (new BWG4BiomesDefault(129, 2, 3)).setColor(353825).setBiomeName("Snow Taiga").setTemperatureRainfall(0.0F, 0.0F).setMinMaxHeight(0.2F, 0.7F).setEnableSnow().beach(1);
	...
	public static final BiomeGenBase BDpines = (new BWG4BiomesDefault(136, 3, 5)).setColor(353825).setBiomeName("Pines").setTemperatureRainfall(0.8F, 0.6F).setMinMaxHeight(0.2F, 0.7F).beach(1);
	public static final BiomeGenBase BDtaiga = (new BWG4BiomesDefault(137, 3, 6)).setColor(353825).setBiomeName("Taiga").setTemperatureRainfall(0.8F, 0.6F).setMinMaxHeight(0.2F, 0.7F).beach(1);
	...
	//GOLD 184/255
	public static final BiomeGenBase GOLD1coldHills = (new BWG4BiomesGold1(184, 2, 1)).setColor(1456435).setBiomeName("ColdHills_Hills").setMinMaxHeight(1.8F, 3.0F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(75, true).snow(80);
	public static final BiomeGenBase GOLD1coldDeep = (new BWG4BiomesGold1(185, 2, 2)).setColor(1456435).setBiomeName("ColdHills_Deep").setMinMaxHeight(0.8F, 5.0F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(75, true).snow(80);
	public static final BiomeGenBase GOLD1coldForest = (new BWG4BiomesGold1(186, 2, 3)).setColor(1456435).setBiomeName("ColdHills_Forest").setMinMaxHeight(0.3F, 0.3F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(75, true).snow(100);
	public static final BiomeGenBase GOLD1coldFields = (new BWG4BiomesGold1(187, 2, 4)).setColor(1456435).setBiomeName("ColdHills_Fields").setMinMaxHeight(0.3F, 0.3F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(75, true).snow(100);
	public static final BiomeGenBase GOLD1coldLakes = (new BWG4BiomesGold1(188, 2, 5)).setColor(1456435).setBiomeName("ColdHills_Lakes").setMinMaxHeight(-0.3F, 0.6F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(75, true).snow(62);
	
	public static final BiomeGenBase GOLD1snowpineLake = (new BWG4BiomesGold1(109, 1, 1)).setColor(1456435).setBiomeName("SnowPine_Lake").setMinMaxHeight(-0.9F, 0.6F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(105, true).snow(62);
	public static final BiomeGenBase GOLD1snowpineBeach = (new BWG4BiomesGold1(200, 1, 2)).setColor(1456435).setBiomeName("SnowPine_Beach").setMinMaxHeight(-0.2F, 0.4F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(105, true).snow(62);
	public static final BiomeGenBase GOLD1snowpineForest = (new BWG4BiomesGold1(201, 1, 3)).setColor(1456435).setBiomeName("SnowPine_Forest").setMinMaxHeight(0.6F, 0.7F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(105, true).snow(62);
	public static final BiomeGenBase GOLD1snowpineField = (new BWG4BiomesGold1(202, 1, 4)).setColor(1456435).setBiomeName("SnowPine_Field").setMinMaxHeight(0.6F, 0.7F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(105, true).snow(62);
	public static final BiomeGenBase GOLD1snowpineHigh = (new BWG4BiomesGold1(203, 1, 5)).setColor(1456435).setBiomeName("SnowPine_High").setMinMaxHeight(1.6F, 1.6F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(105, true).snow(62);
	public static final BiomeGenBase GOLD1snowpineBorder = (new BWG4BiomesGold1(204, 1, 6)).setColor(1456435).setBiomeName("SnowPine_Border").setMinMaxHeight(0.3F, 0.4F).setTemperatureRainfall(0.0F, 0.0F).beach(3).mountain(105, true).snow(62);
	
	public static final BiomeGenBase GOLD1iceOcean = (new BWG4BiomesGold2(205, 3, 1)).setColor(1456435).setBiomeName("Ice_Ocean").setMinMaxHeight(-1.1F, 0.3F).setTemperatureRainfall(0.0F, 0.0F).beach(3).snow(62);
	public static final BiomeGenBase GOLD1icePlains = (new BWG4BiomesGold2(206, 3, 2)).setColor(1456435).setBiomeName("Ice_Plains").setMinMaxHeight(0.3F, 0.2F).setTemperatureRainfall(0.0F, 0.0F).beach(3).snow(62);
	public static final BiomeGenBase GOLD1iceForest = (new BWG4BiomesGold2(207, 3, 3)).setColor(1456435).setBiomeName("Ice_Forest").setMinMaxHeight(0.2F, 0.2F).setTemperatureRainfall(0.0F, 0.0F).beach(3).snow(62);
	public static final BiomeGenBase GOLD1iceBorder = (new BWG4BiomesGold2(208, 3, 4)).setColor(1456435).setBiomeName("Ice_Border").setMinMaxHeight(0.3F, 0.3F).setTemperatureRainfall(0.0F, 0.0F).beach(3).snow(62);
	...
	public static final BiomeGenBase GOLD4desertOasis = (new BWG4BiomesGold4(243, 1, 4)).setColor(353825).setBiomeName("Desert_Oasis").setTemperatureRainfall(1.0F, 0.8F).setDisableRain().setMinMaxHeight(0.1F, 0.3F).beach(2).disableLakes();
