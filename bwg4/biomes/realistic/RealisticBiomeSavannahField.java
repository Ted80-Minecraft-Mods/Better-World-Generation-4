...
public class RealisticBiomeSavannahField extends BiomeGenBase implements RealisticBiome
{
	public RealisticBiomeSavannahField(int id) 
	{
		super(id);
	}
	...
	public void rDecorate(World world, Random rand, int chunkX, int chunkY, PerlinNoise perlin) 
	{
		...
		if(perlin.noise2(chunkX / 180f, chunkY / 180f) > 0.20f)
		{
			for(int b33 = 0; b33 < 5; b33++)
			{
				...
				WorldGenerator worldgenerator = rand.nextInt(7) == 0 ? new WorldGenShrub(0, 0) : rand.nextInt(5) == 0 ? new DecoSavannah(1): new DecoSavannah(2);
