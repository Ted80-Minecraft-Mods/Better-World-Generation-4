...
import bwg4.noise.NoiseOctavesAlpha;
...
public class ChunkGeneratorAlpha implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Pre(ichunkprovider, worldObj_16, field_913_j, i, j, false));
		
        if (mapFeaturesEnabled)
        {
			strongholdGenerator.generateStructuresInChunk(worldObj_16, field_913_j, i, j);
			mineshaftGenerator.generateStructuresInChunk(worldObj_16, field_913_j, i, j);
		}	
        ...
        for(int i1 = 0; i1 < 8; i1++)
        {
            ...
            (new DecoDungeons()).generate(worldObj_16, field_913_j, i4, k6, l8);
        }
        ...
        for(int j11 = 0; j11 < 2; j11++)
        {
            ...
            (new WorldGenFlowers(Blocks.yellow_flower)).generate(worldObj_16, field_913_j, j13, i16, k18);
        }
        ...
        if(field_913_j.nextInt(2) == 0)
        {
            ...
            (new WorldGenFlowers(Blocks.red_flower)).generate(worldObj_16, field_913_j, k11, k13, j16);
        } 
        if(field_913_j.nextInt(4) == 0)
        {
            ...
            (new WorldGenFlowers(Blocks.brown_mushroom)).generate(worldObj_16, field_913_j, l11, l13, k16);
        }
        if(field_913_j.nextInt(8) == 0)
        {
            ...
            (new WorldGenFlowers(Blocks.red_mushroom)).generate(worldObj_16, field_913_j, i12, i14, l16);
        } 
        ...
        for(int i15 = 0; i15 < 50; i15++)
        {
            ...
            (new WorldGenLiquids(Blocks.flowing_water)).generate(worldObj_16, field_913_j, l17, j19, j20);
        }
        ...
        for(int j15 = 0; j15 < 20; j15++)
        {
            ...
            (new WorldGenLiquids(Blocks.flowing_lava)).generate(worldObj_16, field_913_j, i18, k19, k20);
        }

		SpawnerAnimals.performWorldGenSpawning(worldObj_16, biomegenbase, k + 8, l + 8, 16, 16, field_913_j);
		
        field_4178_w = ChunkManagerOld.getColdTemperatures(field_4178_w, k + 8, l + 8, 16, 16);
