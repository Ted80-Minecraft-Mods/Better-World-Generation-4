...
public class ChunkGeneratorInfdev implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i1 = 0; i1 < 8; i1++)
        {
            ...
            (new DecoDungeons()).generate(field_907_p, field_913_j, i4, j6, i11);
        }
        ...
        for(int l8 = 0; l8 < 2; l8++)
        {
            ...
            (new WorldGenFlowers(Blocks.yellow_flower)).generate(field_907_p, field_913_j, k13, i16, j18);
        }
        ...
        if(field_913_j.nextInt(2) == 0)
        {
            ...
            (new WorldGenFlowers(Blocks.red_flower)).generate(field_907_p, field_913_j, i9, l13, j16);
        }
        ...
        if(alpha)
        {
	        if(field_913_j.nextInt(4) == 0)
	        {
	            ...
	            (new WorldGenFlowers(Blocks.brown_mushroom)).generate(field_907_p, field_913_j, j9, i14, k16);
	        }
	        if(field_913_j.nextInt(8) == 0)
	        {
	            ...
	            (new WorldGenFlowers(Blocks.red_mushroom)).generate(field_907_p, field_913_j, k9, j14, l16);
	        }
        }
        else
        {
        ...
        for(int j10 = 0; j10 < 50; j10++)
        {
            ...
            (new WorldGenLiquids(Blocks.flowing_water)).generate(field_907_p, field_913_j, i15, k17, i19);
        }
        ...
        for(int k10 = 0; k10 < 20; k10++)
        {
            ...
            (new WorldGenLiquids(Blocks.flowing_lava)).generate(field_907_p, field_913_j, j15, l17, j19);
        }
