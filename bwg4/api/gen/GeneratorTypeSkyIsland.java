...
{
	public GeneratorTypeSkyIsland(int id, int cat, String name, String screen, boolean c) 
	{
	...
	{
		gui.settings.add(new GuiSettingsButton(new String[]{"Theme: Default", "Theme: Snow", "Theme: Jungle"}, new int[]{0, 1, 2}, 20, 80, gui.width)); 
		return true;
	}
