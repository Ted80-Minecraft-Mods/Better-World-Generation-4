...
public class DecoGold1 extends WorldGenerator
{
	...
	//NORMAL OBJECT
    public DecoGold1(int object)
    {
		objectID = object;
    }
	
	//TREE OBJECTS WITH INPUT
    public DecoGold1(int object, int in1, int in2, int in3)
    {
		objectID = object;
		input1 = in1;
		input2 = in2;
    ...
    public boolean generate(World par1World, Random par2Random, int x, int y, int z)
    {
		...
		{	
			...
			for (int i1 = y; i1 <= y + 1 + i && flag; i1++)
			{
				...
				for (int i2 = x - k1; i2 <= x + k1 && flag; i2++)
				{
					for (int l2 = z - k1; l2 <= z + k1 && flag; l2++)
					{
						if (i1 >= 0 && i1 < 128)
						{
							Block k3 = par1World.getBlock(i2, i1, l2);
			...
			Block j1 = par1World.getBlock(x, y - 1, z);

			if (j1 != Blocks.grass && j1 != Blocks.dirt || y >= 128 - i - 1)
			{
				return false;
			}

			par1World.setBlock(x, y - 1, z, Blocks.dirt);
			int l1 = 0;
			...
			{
				Block j3 = par1World.getBlock(x, y + k2, z);

				if (j3 == Blocks.air || j3 == Blocks.leaves)
				{
					par1World.setBlock(x, y + k2, z, Blocks.log, 0, 0);
				}
			}
		...
		{	
			...
			for (int i1 = y; i1 <= y + 1 + i && flag; i1++)
			{
				...
				for (int i2 = x - k1; i2 <= x + k1 && flag; i2++)
				{
					for (int k2 = z - k1; k2 <= z + k1 && flag; k2++)
					{
						if (i1 >= 0 && i1 < 256)
						{
							Block l2 = par1World.getBlock(i2, i1, k2);
			...
			if (j1 != Blocks.grass && j1 != Blocks.dirt || y >= 256 - i - 1)
			{
				return false;
			}
			...
			{
				Block j4 = par1World.getBlock(x, y + l3, z);

				if (j4 == Blocks.air || j4 == Blocks.leaves)
				{
					par1World.setBlock(x, y + l3, z, Blocks.log);
				}
			}
		...
		{	
			for (int var7 = 0; var7 < 32; ++var7)
			{
				...
				Block var11 = par1World.getBlock(var8, 62, var10);
				double count = 0.01D;
				
				if (var11 == Blocks.water)
				{
					for(int deep = 1; deep < 8; deep++)
					{
						Block var22 = par1World.getBlock(var8, 62 - deep, var10);
						if(var22 != Blocks.water)
						{
							break;
						}
						else
					...
					if(count < 4.0D)
					{
						...
						{
							par1World.setBlock(var8, 62, var10, Blocks.ice, 0, 0);
						}	
					}	
				}
			}
		...
		else if(objectID == 5)//new pine tree
		{
			...
			//wood
			for(int ty1 = y - 3; ty1 < randheight + y; ty1++ )  { Block block = par1World.getBlock(x, ty1, z); if(block == Blocks.air) { par1World.setBlock(x, ty1, z, Blocks.log, 12, 0); } }
			
			//root
			for(int ry1 = y - 3; ry1 < y + 5; ry1++ ) { Block block = par1World.getBlock(x + 1, ry1, z); if(block == Blocks.air) { par1World.setBlock(x + 1, ry1, z, Blocks.log, 12, 0); if(ry1 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
			for(int ry2 = y - 3; ry2 < y + 5; ry2++ ) { Block block = par1World.getBlock(x - 1, ry2, z); if(block == Blocks.air) { par1World.setBlock(x - 1, ry2, z, Blocks.log, 12, 0); if(ry2 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
			for(int ry3 = y - 3; ry3 < y + 5; ry3++ ) { Block block = par1World.getBlock(x, ry3, z - 1); if(block == Blocks.air) { par1World.setBlock(x, ry3, z - 1, Blocks.log, 12, 0); if(ry3 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
			for(int ry4 = y - 3; ry4 < y + 5; ry4++ ) { Block block = par1World.getBlock(x, ry4, z + 1); if(block == Blocks.air) { par1World.setBlock(x, ry4, z + 1, Blocks.log, 12, 0); if(ry4 > y + 0 && par2Random.nextInt(3) == 0) { break; } } }
